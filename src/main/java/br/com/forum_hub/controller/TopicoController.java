...
public class TopicoController {
    ...
    @PutMapping
    public ResponseEntity<DadosListagemTopico> atualizar(@RequestBody @Valid DadosAtualizacaoTopico dados,@AuthenticationPrincipal Usuario logado) throws AccessDeniedException {
