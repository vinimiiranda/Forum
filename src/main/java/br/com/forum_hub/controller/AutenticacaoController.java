...
public class AutenticacaoController {
    ...
    public ResponseEntity<DadosToken> efetuarLogin(@Valid @RequestBody DadosLogin dados) {
        ...
        String tokenAcesso = tokenService.gerarToken((Usuario) authetication.getPrincipal());
        String refreshToken = tokenService.gerarRefreshToken((Usuario) authetication.getPrincipal());
